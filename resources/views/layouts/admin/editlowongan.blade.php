          ...
          <div class="card">
            ...
            <div class="card-header">
              <h4 class="card-header-title">
                Form Edit Lowongan {{ $lowongan->nama_sekolah }}
              </h4>
            </div>
            <!-- End Header -->
...
@endif
            <form action="{{ route('lowongan.prosesupdate', $lowongan->id)}}" method="post" enctype="multipart/form-data">
              @csrf		   
			  @method('PUT')  
			  
				<div class="row">
				  <label class="col-sm-3 col-form-label">Nama Lowongan</label>
				  <div class="col-sm-9">
                  <select required name="nama_sekolah" class="form-select" aria-label="Default select example">
                    <option>{{ $lowongan->nama_sekolah }}</option>
				...
				<div class="row">
				  ...
				  <div class="col-sm-9">
					<select type="text" class="form-select" required name="matapel">
                                <option>{{ $lowongan->matapel }}</option>
				...
				<div class="row">
				  ...
				  <div class="col-sm-9">
					<input type="number" class="form-control" required name="kebutuhan" value="{{ $lowongan->kebutuhan}}">
				  </div>
				</div>
				<br>          
				<div class="row">
